...
_Note: The default size of the plot is optimized to look good for the "Plots" tab in Rstudio. For an Rmarkdown file set the chunk options to `fig.width=3, fig.height=3, dpi=300`._

```{r standard_plot, dpi=300, fig.width=5, fig.height=3}
