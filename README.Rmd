...
```{r standard_plot, dpi=300, fig.width=7, fig.height=4}
...
```{r standard_plot_labels, dpi=300, fig.width=7, fig.height=4}
...
```{r standard_plot_labels_wells, dpi=300, fig.width=7, fig.height=4}
# Create a 96-well plot with labels
plate_plot(data = data_continuous_96, 
           position = well, 
           value = Value, 
...
```{r standard_plot_384_well_new_limits, dpi=300, fig.width=7, fig.height=4}
...
```{r standard_plot_384_well_new_limits_outlier, dpi=300, fig.width=7, fig.height=4}
...
```{r standard_plot_384_well_new_gradient, dpi=300, fig.width=7, fig.height=4}
...
```{r standard_plot_48_empty_wells, dpi=300, fig.width=7, fig.height=4}
...
```{r standard_plot_6_well, dpi=300, fig.width=7, fig.height=4, out.width="80%", fig.align='center'}
...
```{r 6_well_plot_new_colours, dpi=300, fig.width=7, fig.height=4, out.width="80%", fig.align='center'}
...
```{r 6_well_plot_new_colours_no_legend, dpi=300, fig.width=7, fig.height=4, out.width="80%", fig.align='center'}
# Create a 6-well plot 
plate_plot(data = data_discrete_6, 
           position = well, 
           value = Condition, 
...
As you can see for the bellow example the graphics device size is `width: 7.292 height: 4.507` and the scaling factor is `1.308`. 

```{r return_device_size, dpi=300, fig.width=7, fig.height=4}
...
```{r resize_plot, dpi=300, fig.width=7, fig.height=4}
# Create a 24-well plot 
plate_plot(data = data_discrete_24, 
           position = well, 
           value = Condition, 
...
```{r 24_well_plate_legend_n_row, dpi=300, fig.width=7, fig.height=4}
...
```{r discrete_96_well_plate, dpi=300, fig.width=7, fig.height=4}
...
```{r discrete_96_well_plate_label, dpi=300, fig.width=7, fig.height=4}
# Create a 96-well plot with labels
plate_plot(data = data_discrete_96, 
           position = well, 
           value = Compound, 
