...
_Note: The default size of the plot is optimized to look good for the "Plots" tab in Rstudio. For an Rmarkdown file the `fig.width` argument should be set to 2.4._

```{r standard_plot, fig.width=2.4}
